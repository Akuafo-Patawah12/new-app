...
const BusinessFinanceData = (props) => {
        ...
        <div className={`transit bg-white overflow-hidden w-[95%] h-[80px] mx-auto rounded-lg py-2 px-3 
          ...
          <div>
            <h2 className='font-bold flex gap-1'>
              ...
              className={`
              w-6 h-6 bg-gray-300 border-2 border-stone-700 transition rounded-[50%] grid place-items-center
             `}>
...
export default BusinessFinanceData;